...
import models.{OAuth2InfoRepository, PasswordRepository, UserLogsRepository}
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  @Provides
  def provideEnvironment(userRepository: UserLogsRepository,
  ...
  def passwordInfoDao(dbConfigProvider: DatabaseConfigProvider): DelegableAuthInfoDAO[PasswordInfo] =
    new PasswordRepository(dbConfigProvider)
